    ...
    <div className="bg-white text-black pb-[100px] mt-[55px]">
      ...
      <div className="bg-[#F0F0F0] rounded-lg shadow-md p-4 mt-4">
        ...
        <Typography variant="body2" color="text.secondary">
          This User Agreement, Privacy Policy, terms, conditions, and all policies published on the "Youdra" platform are set to protect and preserve the rights of both the Youdra Information Technology Foundation and the user who accesses the site with or without registration, or the consumer benefiting from the content with or without registration.
        </Typography>
      </div>
      ...
      <div className="bg-[#F0F0F0] rounded-lg shadow-md p-4 mt-4">
        ...
        <Typography variant="body2" color="text.secondary">
          Youdra Platform: An electronic platform that allows users to create an account to publish their content according to regulations and legislation.
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
          User: The account creator on the Youdra platform for the purpose of communication, browsing, publishing content, or creating an electronic store.
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
      ...
      <div className="bg-[#F0F0F0] rounded-lg shadow-md p-4 mt-4">
        ...
        <Typography variant="body2" color="text.secondary">
          As a second party in this agreement and as a beneficiary of the services of the Youdra platform, you must comply with the following.
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
        ...
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
          Do not use any illegal means to access advertisements or other users' data, violate the policies and rights of Youdra Information Technology Foundation, access platform content, or collect information and data concerning Youdra or its clients and use them in any form or republish them.
        ...
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
          Do not involve in policies, international sovereignties, prominent figures, or any unlawful discussions in Youdra Information Technology Foundation.
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
          Do not transfer your account or activity to other sites while it carries the logo or services of the foundation.
          Do not infringe upon the intellectual property rights of the Youdra Information Technology Foundation, including copyright, trademarks, patents, publicity rights, database rights, or any other intellectual property rights belonging to the foundation or licensed to it.
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
        ...
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
          Do not engage in any activity that could harm the reputation of the Youdra Information Technology Foundation in any way, whether on the platform itself or on other social media platforms, and the foundation reserves its right to claim all resulting damages.
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
          Do not impersonate the Youdra Information Technology Foundation, its representative, or its employee, or any capacity suggesting you are affiliated with the foundation unless you have official permission from the foundation.
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
      ...
      <div className="bg-[#F0F0F0] rounded-lg shadow-md p-4 mt-4">
        ...
        <Typography variant="body2" color="text.secondary">
          Membership is the username that the person registered with on the Youdra platform, linked to their mobile number, and must be subject to the following conditions:
        </Typography>
        <Typography variant="body2" color="text.secondary" className="mt-4" sx={{ marginTop: "20px" }}>
